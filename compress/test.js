...
var compressed = compress.compress(obj);

//save compressed js to command line + .comp
fs.writeFileSync(process.argv[2] + ".comp", JSON.stringify(compressed));

//fs.writeFileSync(process.argv[2] + '.comp.lz', LZString.compress(JSON.stringify(compressed)));

//var decompressed = compress.decompress(compressed);

//fs.writeFileSync(process.argv[2] + '.decomp', JSON.stringify(decompressed));
