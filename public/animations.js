...
function login_error(err_msg) {
  ...
  document
    ...
    .addEventListener("input", un_error, false);
  document
...
function password_error(err_msg) {
  ...
  document
    .getElementById("new_user_password")
    .addEventListener("input", un_error, false);
}
...
function wait_challenge_view() {
  ...
  setTimeout(function () {
    ...
    document.getElementById("waiting_head_text").innerHTML =
  ...
  switch (elid) {
    case "info_spirit_size":
      info_content.innerHTML =
        "<span class='g_con'><span class='ico_circle'></span> Circles</span><div class='sep_mini'></div><table class='info_table'><tr><td>1</td><td>Default size</td></tr><tr><td>100</td><td>Max size (100 spirits merged together)</td></tr></table><div class='sep_mini'></div><div class='sep_small'></div>";
      break;
    case "info_spirit_energy_capacity":
      info_content.innerHTML =
        "<p class='p_normal'>energy_capacity = 10 × size</p><div class='sep_mini'></div>";
      break;
    case "info_spirit_sight":
      info_content.innerHTML =
        "<pre class='code_sample'>my_spirits[1].sight = &#10;{&#10;  <span class='lowlight'>friends:</span> [‘jane2’, ‘jane3’, ‘jane4’],&#10;  <span class='lowlight'>enemies:</span> [‘karl4’],&#10;  <span class='lowlight'>structures:</span> [‘star_zxq’]&#10;}</pre>			<div class='sep_small'></div>			<p class='p_normal' style='width: 400px; line-height: 26px'>there are 3 friendly and 1 enemy spirit and a star within 400 radius around the spirit</p>			<pre class='code_sample'>my_spirits[1].sight.enemies[0];</pre>			<pre class='code_sample'><span class='lowlight'>output:</span> 'karl4'</pre>			<div class='sep_medium'></div>";
      break;
    case "info_base_sight":
      info_content.innerHTML =
        "<pre class='code_sample'>base.sight = &#10;{&#10;  <span class='lowlight'>friends:</span> [‘jane2’, ‘jane3’, ‘jane4’],&#10;  <span class='lowlight'>enemies:</span> [‘karl4’],&#10;  <span class='lowlight'>structures:</span> []&#10;}</pre>			<div class='sep_small'></div>			<p class='p_normal' style='width: 400px; line-height: 26px'>there are 3 friendly and 1 enemy spirit within 400 radius around the base</p>			<pre class='code_sample'>base.sight.enemies[0];</pre>			<pre class='code_sample'><span class='lowlight'>output:</span> 'karl4'</pre>			<div class='sep_medium'></div>";
      break;
    case "info_outpost_sight":
      info_content.innerHTML =
        "<pre class='code_sample'>outpost.sight = &#10;{&#10;  <span class='lowlight'>enemies:</span> [‘jane2’, ‘jane3’, ‘jane4’]&#10;}<span class='lowlight'></pre>			<div class='sep_small'></div>			<p class='p_normal' style='width: 400px; line-height: 26px'>there are 3 enemy spirits within outpost's range</p>			<pre class='code_sample'>enemy.sight.enemies[0];</pre>			<pre class='code_sample'><span class='lowlight'>output:</span> 'jane2'</pre>			<div class='sep_medium'></div>";
      break;
    case "info_birth":
      info_content.innerHTML =
        "<span class='g_con'><span class='ico_circle'></span> Circles new spirit cost</span><div class='sep_mini'></div><table class='info_table'><tr><td>1–50 spirits</td><td>25 energy</td></tr><tr><td>51–100</td><td>50 energy</td></tr><tr><td>101–200</td><td>100 energy</td></tr><tr><td>201–300</td><td>200 energy</td></tr><tr><td>301+ spirits</td><td>400 energy</td></tr></table><div class='sep_small'></div><span class='g_con'><span class='ico_square'></span> Squares new spirit cost</span><div class='sep_mini'></div><table class='info_table'><tr><td>1–10 spirits</td><td>360 energy</td></tr><tr><td>11+ spirits</td><td>700 energy</td></tr></table><div class='sep_small'></div><span class='g_con'><span class='ico_triangle'></span> Triangles new spirit cost</span><div class='sep_mini'></div><table class='info_table'><tr><td>1–30 spirits</td><td>90 energy</td></tr><tr><td>31-120 spirits</td><td>120 energy</td></tr><tr><td>121+ spirits</td><td>300 energy</td></tr></table><div class='sep_mini'></div><div class='sep_small'></div>";
      break;
  }
...
function expand_documentation(elid, rotator) {
  try {
    ...
    var exp_el = document
      .querySelector("#" + elid + " div.exp_content")
      .getBoundingClientRect();
  } catch (error) {
    console.error(error);
  }
...
function check_login() {
  if (
    getCookie("session_id") != null &&
    getCookie("user_id") != null &&
    getCookie("user_id") != "anonymous"
  ) {
    window.location = "./hub";
  } else {
    new_account();
...
try {
  document
    .getElementById("action_start_playing")
    .addEventListener("click", check_login, false);
} catch (error) {}
...
document
  .getElementById("signed_in")
  .addEventListener("click", user_links, false);

try {
  document
    .getElementById("over_new_account")
    .addEventListener("click", new_account, false);
