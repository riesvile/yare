try {
	...
	function update_gph_data(){
		...
		if (Math.abs(energy_diff) > global_max){
			if (Math.abs(energy_diff) > global_max * 5) global_max = Math.abs(energy_diff) + 20;
			global_max += Math.max(10, Math.round(global_max * 0.25));
		...
		gph_points[current_tick] = energy_diff;
		
		let energy_diff_mapped = map_values(gph_points[current_tick], -global_max, global_max, 24, -24);
	...
	function redraw_gph(){
		...
		for (let ti in gph_points) {
			let new_point = ti + ', ' + map_values(gph_points[ti], -global_max, global_max, 24, -24);
	...
	let gph_css = "#graph_base { position: fixed; bottom: -20px; right: 24px; width: 600px; height: 100px; pointer-events: none; overflow-x: scroll; white-space: nowrap; } #graph_wrap { position: fixed; bottom: -20px; right: 24px; width: 200px; height: 100px; overflow-x: scroll; white-space: nowrap; pointer-events: auto; opacity: 0;} .gph_section { width: 100%; height: 11px; } .gph_line { width: 3000px; height: 1px; margin-top: 4px; background-color: rgba(242, 246, 250, 0.1); float: left; } .gph_line_highlight { background-color: rgba(242, 246, 250, 0.2); } .gph_lbl_v { font-size: 8px; font-weight: 500; display: block; width: 20px; line-height: 10px; float: left; text-align: right; padding-right: 6px; margin-left: -26px; position: fixed; color: rgba(242, 246, 250, 0.69); } #gph_empty { width: 100%; height: 20px; clear: both; } #gph_ticks_legend { position: absolute; top: 44px; left: -6px; clear: both; } .gph_tick_lbl { display: inline-block; width: 100px; font-size: 8px; font-weight: 500; white-space: nowrap; color: rgba(242, 246, 250, 0.39); margin-left: -5px; } .gph_tick_lbl:first-child { margin-left: 6px; } .gph_lbl_highlight { color: rgba(242, 246, 250, 0.69); } #graph_content_wrap { position: absolute; top: 0; left: 0; /*width: 600px;*/ height: 80px; } #gph_svg { width: 1000px; } #gph_minimized { position: fixed; bottom: 30px; right: 30px; z-index: 9; pointer-events: auto; } #gph_mini_legend_wrap { position: relative; float: left; width: 20px; height: 48px; margin-right: 6px; opacity: 1; } .gph_mini_legend { color: rgba(242, 246, 250, 0.69); font-size: 8px; font-weight: 500; display: block; width: 20px; text-align: right; position: absolute; pointer-events: none; } #gph_mini_legend_lbl1 { top: 0; } #gph_mini_legend_lbl2 { top: 50%; transform: translateY(-50%); color: rgba(242, 246, 250, 0.4); } #gph_mini_legend_lbl3 { bottom: 0; } .gph_mini_bar { width: 8px; height: 48px; background-color: rgba(242, 246, 250, 0.2); float: left; border-radius: 2px; position: relative; pointer-events: none; opacity: 1; } #gph_mini_current_bar { margin-right: 12px; pointer-events: auto; } #gph_mini_current_val { position: absolute; top: 10px; width: 100%; height: 1px; background-color: #92949a; border-radius: 1px; transition: 0.1s ease-out; } #gph_mini_players { height: 48px; float: right; font-size: 10px; font-weight: 500; } #mini_player1, #mini_player2 { height: 50%; } #mini_player1_name, #mini_player2_name { position: relative; padding-left: 14px; top: 50%; transform: translateY(-50%); } #mini_player1_shape, #mini_player2_shape { position: absolute; top: 0px; left: -2px; width: 12px; height: 12px; margin-top: 0; margin-right: 0; } #gph_bars_wrap { position: relative; } .gph_info_hover { position: absolute; left: -20px; bottom: 48px; font-size: 10px; font-weight: 500; width: 120px; height: 50px; text-shadow: 0px 0px 4px #000; pointer-events: none; opacity: 0; } .gph_info_current { width: 52px; height: 50px; text-align: right; float: left; } .bar_legend { display: inline-block; margin-bottom: 4px; color: rgba(242, 246, 250, 0.96); } #gph_minimized:hover .gph_info_hover { opacity: 1; } #graph_base:hover .gph_info_hover { opacity: 1; }";
	...
	graph_base.innerHTML = "<div id='graph_wrap' onClick=gph_view_toggle('minimize')> <div id='gph_sec1' class='gph_section'> <span id='gph_lbl1' class='gph_lbl_v'>20</span> <div id='gph_line1' class='gph_line gph_line_highlight'></div> </div> <div id='gph_sec2' class='gph_section'> <span id='gph_lbl2' class='gph_lbl_v'>&nbsp;</span> <div id='gph_line2' class='gph_line'></div> </div> <div id='gph_sec3' class='gph_section'> <span id='gph_lbl3' class='gph_lbl_v'>0</span> <div id='gph_line3' class='gph_line gph_line_highlight'></div> </div> <div id='gph_sec4' class='gph_section'> <span id='gph_lbl4' class='gph_lbl_v'>&nbsp;</span> <div id='gph_line4' class='gph_line'></div> </div> <div id='gph_sec5' class='gph_section'> <span id='gph_lbl5' class='gph_lbl_v'>20</span> <div id='gph_line5' class='gph_line gph_line_highlight'></div> </div> <div id='gph_empty'></div> <div id='gph_ticks_legend'> <span class='gph_tick_lbl gph_lbl_highlight'>0</span> <span class='gph_tick_lbl'>100</span> <span class='gph_tick_lbl'>200</span> <span class='gph_tick_lbl'>300</span> <span class='gph_tick_lbl gph_lbl_highlight'>400</span> <span class='gph_tick_lbl'>500</span> <span class='gph_tick_lbl'>600</span> <span class='gph_tick_lbl'>700</span> <span class='gph_tick_lbl gph_lbl_highlight'>800</span><span class='gph_tick_lbl'>900</span> <span class='gph_tick_lbl'>1000</span> <span class='gph_tick_lbl'>1100</span> <span class='gph_tick_lbl gph_lbl_highlight'>1200</span><span class='gph_tick_lbl'>1300</span> <span class='gph_tick_lbl'>1400</span> <span class='gph_tick_lbl'>1500</span> <span class='gph_tick_lbl gph_lbl_highlight'>1600</span><span class='gph_tick_lbl'>1700</span> <span class='gph_tick_lbl'>1800</span> <span class='gph_tick_lbl'>1900</span> <span class='gph_tick_lbl gph_lbl_highlight'>2000</span> </div> <div id='graph_content_wrap'> <svg id='gph_svg' style='width: 100%; height: 60px;' overflow='visible' viewBox='0 -25 600 60'> <defs> <linearGradient id='gph_gradient' x1='0%' y1='0%' x2='0%' y2='100%'> <stop offset='0%' style='stop-color: hsl(" + color1_hsl[0] + ", " + color1_hsl[1] + "%, " + (color1_hsl[2] + 2) + "%);' /> <stop offset='40%' style='stop-color: hsl(" + color1_hsl[0] + ", " + 30 + "%, " + (color1_hsl[2]) + "%);' /> <stop offset='50%' style='stop-color:#f4f2fa; stop-opacity: 0.5' /> <stop offset='60%' style='stop-color: hsl(" + color2_hsl[0] + ", " + 30 + "%, " + (color2_hsl[2]) + "%);' /> <stop offset='100%' style='stop-color: hsl(" + color2_hsl[0] + ", " + color2_hsl[1] + "%, " + (color2_hsl[2] + 2) + "%);' /> </linearGradient> </defs> <polyline id='gph_polyline' points='-1, 24 -1, -24 -1, 0' style='fill:none; stroke: url(#gph_gradient); stroke-width: 1'> <!-- 100, 24 200, -24 250, 10 300, -10 350, -15 400, 20 500, -20 600, 12 700, 5 --> </svg> </div> </div>";
	document.getElementById("modules_plate").appendChild(graph_base);
	
	let minimized_html = "<div id='gph_minimized' onClick=gph_view_toggle('maximize')> <div id='gph_mini_legend_wrap'> <span id='gph_mini_legend_lbl1' class='gph_mini_legend'>20</span> <span id='gph_mini_legend_lbl2' class='gph_mini_legend'>0</span> <span id='gph_mini_legend_lbl3' class='gph_mini_legend'>20</span> </div> <div id='gph_mini_current_bar' class='gph_mini_bar'> <div id='gph_mini_current_val'></div> </div> <div id='gph_mini_players'> <div id='mini_player1'> <p id='mini_player1_name'><span id='mini_player1_shape' class='ico_circle'></span>levmi</p> </div> <div id='mini_player2'> <p id='mini_player2_name'><span id='mini_player2_shape' class='ico_square'></span>k</p> </div> </div> <div class='gph_info_hover'> <div class='gph_info_current'> <span class='bar_legend'>Current energy</span> <span id='legend_value_current'>+180</span> </div> </div> </div>";
	...
	//player info
	document.getElementById('mini_player1').innerHTML = "<p id='mini_player1_name'><span id='mini_player1_shape' class='ico_triangles' style='background-color: " + colors['color1'] + "'></span>" + players['player1'] + "</p>";
	document.getElementById('mini_player2').innerHTML = "<p id='mini_player2_name'><span id='mini_player2_shape' class='ico_triangles' style='background-color: " + colors['color2'] + "'></span>" + players['player2'] + "</p>";
