...
app.get('/' + this_server + 'ahub', (req, res) => res.sendFile(__dirname + '/hub.html'));
app.get('/' + this_server + 'agame', (req, res) => res.sendFile(__dirname + '/game3.html'));
app.get('/' + this_server + 'anewgame', (req, res) => res.sendFile(__dirname + '/newgame.html'));
app.get('/' + this_server + 'adocumentation', (req, res) => res.sendFile(__dirname + '/documentation.html'));
app.get('/' + this_server + 'aleaderboard', (req, res) => res.sendFile(__dirname + '/leaderboard.html'));
app.get('/' + this_server + 'aanimations.js', (req, res) => res.sendFile(__dirname + '/animations.js'));
app.get('/' + this_server + 'arendering.js', (req, res) => res.sendFile(__dirname + '/rendering.js'));
app.get('/' + this_server + 'arendering3.js', (req, res) => res.sendFile(__dirname + '/rendering3.js'));
app.get('/' + this_server + 'abasics.js', (req, res) => res.sendFile(__dirname + '/basics.js'));
app.get('/' + this_server + 'achallenge.js', (req, res) => res.sendFile(__dirname + '/challenge.js'));
app.get('/' + this_server + 'aloggedin.js', (req, res) => res.sendFile(__dirname + '/loggedin.js'));
app.get('/' + this_server + 'atutorial_texts.js', (req, res) => res.sendFile(__dirname + '/tutorial_texts.js'));
app.get('/' + this_server + 'astyle.css', (req, res) => res.sendFile(__dirname + '/style.css'));
app.get('/' + this_server + 'astyle-mobile.css', (req, res) => res.sendFile(__dirname + '/style-mobile.css'));
app.get('/' + this_server + 'acolors.css', (req, res) => res.sendFile(__dirname + '/colors.css'));
app.get('/' + this_server + 'adocumentation.css', (req, res) => res.sendFile(__dirname + '/documentation.css'));
app.get('/' + this_server + 'asrc-min-noconflict/ace.js', (req, res) => res.sendFile(__dirname + '/src-min-noconflict/ace.js'));
app.get('/' + this_server + 'asrc-min-noconflict/theme-clouds_midnight.js', (req, res) => res.sendFile(__dirname + '/src-min-noconflict/theme-clouds_midnight.js'));
app.get('/' + this_server + 'asrc-min-noconflict/mode-javascript.js', (req, res) => res.sendFile(__dirname + '/src-min-noconflict/mode-javascript.js'));
app.get('/' + this_server + 'asrc-min-noconflict/ext-language_tools.js', (req, res) => res.sendFile(__dirname + '/src-min-noconflict/ext-language_tools.js'));
app.get('/' + this_server + 'asrc-min-noconflict/snippets/javascript.js', (req, res) => res.sendFile(__dirname + '/src-min-noconflict/snippets/javascript.js'));
app.get('/' + this_server + 'asrc-min-noconflict/worker-javascript.js', (req, res) => res.sendFile(__dirname + '/src-min-noconflict/worker-javascript.js'));
app.get('/' + this_server + 'acopenhagen.0-1-4.css', (req, res) => res.sendFile(__dirname + '/copenhagen.0-1-4.css'));
app.get('/' + this_server + 'acopenhagen.0-1-4.min.js', (req, res) => res.sendFile(__dirname + '/copenhagen.0-1-4.min.js'));
app.get('/' + this_server + 'aanime.min.js', (req, res) => res.sendFile(__dirname + '/anime.min.js'));
app.get('/' + this_server + 'asound.js', (req, res) => res.sendFile(__dirname + '/sound.js'));
app.get('/' + this_server + 'awebker.js', (req, res) => res.sendFile(__dirname + '/webker.js'));


app.get('/' + this_server + 'aasset/loader.gif', (req, res) => res.sendFile(__dirname + '/assets/loader.gif'));
app.get('/' + this_server + 'aasset/dropdown.png', (req, res) => res.sendFile(__dirname + '/assets/dropdown.png'));
app.get('/' + this_server + 'aasset/dropdown2.png', (req, res) => res.sendFile(__dirname + '/assets/dropdown2.png'));
app.get('/' + this_server + 'aasset/board.png', (req, res) => res.sendFile(__dirname + '/assets/board.png'));
app.get('/' + this_server + 'aasset/method-move.gif', (req, res) => res.sendFile(__dirname + '/assets/method-move.gif'));
app.get('/' + this_server + 'aasset/method-energize1.gif', (req, res) => res.sendFile(__dirname + '/assets/method-energize1.gif'));
app.get('/' + this_server + 'aasset/method-energize2.gif', (req, res) => res.sendFile(__dirname + '/assets/method-energize2.gif'));
app.get('/' + this_server + 'aasset/method-merge.gif', (req, res) => res.sendFile(__dirname + '/assets/method-merge.gif'));
app.get('/' + this_server + 'aasset/method-divide.gif', (req, res) => res.sendFile(__dirname + '/assets/method-divide.gif'));
app.get('/' + this_server + 'aasset/tr-loader.gif', (req, res) => res.sendFile(__dirname + '/assets/tr-loader.gif'));
app.get('/' + this_server + 'aasset/ico_long_arr_blue.png', (req, res) => res.sendFile(__dirname + '/assets/ico_long_arr_blue.png'));
app.get('/' + this_server + 'aasset/ico_long_arr_purp.png', (req, res) => res.sendFile(__dirname + '/assets/ico_long_arr_purp.png'));
app.get('/' + this_server + 'aasset/ico_long_arr_gold.png', (req, res) => res.sendFile(__dirname + '/assets/ico_long_arr_gold.png'));
app.get('/' + this_server + 'aasset/gal1.png', (req, res) => res.sendFile(__dirname + '/assets/gal1.png'));
app.get('/' + this_server + 'aasset/gal2.png', (req, res) => res.sendFile(__dirname + '/assets/gal2.png'));
app.get('/' + this_server + 'aasset/gal3.png', (req, res) => res.sendFile(__dirname + '/assets/gal3.png'));
app.get('/' + this_server + 'aasset/gal4.png', (req, res) => res.sendFile(__dirname + '/assets/gal4.png'));

app.get('/' + this_server + 'asound/outfoxing.mp3', (req, res) => res.sendFile(__dirname + '/sound/outfoxing.mp3'));
app.get('/' + this_server + 'asound/enemy_incoming.mp3', (req, res) => res.sendFile(__dirname + '/sound/enemy_incoming.mp3'));

app.get('/' + this_server + 'aest', (req, res) => res.sendFile(__dirname + '/est.html'));
app.get('/' + this_server + 'agame-status', (req, res) => res.sendFile(__dirname + '/game-status.html'));
app.get('/' + this_server + 'anope', (req, res) => res.sendFile(__dirname + '/nope.html'));
app.get('/' + this_server + 'asite.webmanifest', (req, res) => res.sendFile(__dirname + '/site.webmanifest'));
app.get('/' + this_server + 'aapple-touch-icon.png', (req, res) => res.sendFile(__dirname + '/apple-touch-icon.png'));
app.get('/' + this_server + 'afavicon-32x32.png', (req, res) => res.sendFile(__dirname + '/favicon-32x32.png'));
app.get('/' + this_server + 'afavicon-16x16.png', (req, res) => res.sendFile(__dirname + '/favicon-16x16.png'));
