...
app.get('/' + this_server + 'a/replay', (req, res) => res.sendFile(__dirname + '/replay3.html'));
...
app.get('/' + this_server + 'a/asset/ico_play.png', (req, res) => res.sendFile(__dirname + '/assets/ico_play.png'));
app.get('/' + this_server + 'a/asset/ico_pause.png', (req, res) => res.sendFile(__dirname + '/assets/ico_pause.png'));
