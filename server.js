...
app.get('/' + this_sever + 'a/favicon.ico', (req, res) => res.sendFile(__dirname + '/favicon.ico'));
app.get('/' + this_sever + 'a/hub', (req, res) => res.sendFile(__dirname + '/hub.html'));
app.get('/' + this_sever + 'a/game', (req, res) => res.sendFile(__dirname + '/game3.html'));
app.get('/' + this_sever + 'a/newgame', (req, res) => res.sendFile(__dirname + '/newgame.html'));
app.get('/' + this_sever + 'a/documentation', (req, res) => res.sendFile(__dirname + '/documentation.html'));
app.get('/' + this_sever + 'a/leaderboard', (req, res) => res.sendFile(__dirname + '/leaderboard.html'));
app.get('/' + this_sever + 'a/animations.js', (req, res) => res.sendFile(__dirname + '/animations.js'));
app.get('/' + this_sever + 'a/rendering.js', (req, res) => res.sendFile(__dirname + '/rendering.js'));
app.get('/' + this_sever + 'a/rendering3.js', (req, res) => res.sendFile(__dirname + '/rendering3.js'));
app.get('/' + this_sever + 'a/basics.js', (req, res) => res.sendFile(__dirname + '/basics.js'));
app.get('/' + this_sever + 'a/challenge.js', (req, res) => res.sendFile(__dirname + '/challenge.js'));
app.get('/' + this_sever + 'a/loggedin.js', (req, res) => res.sendFile(__dirname + '/loggedin.js'));
app.get('/' + this_sever + 'a/tutorial_texts.js', (req, res) => res.sendFile(__dirname + '/tutorial_texts.js'));
app.get('/' + this_sever + 'a/style.css', (req, res) => res.sendFile(__dirname + '/style.css'));
app.get('/' + this_sever + 'a/style-mobile.css', (req, res) => res.sendFile(__dirname + '/style-mobile.css'));
app.get('/' + this_sever + 'a/colors.css', (req, res) => res.sendFile(__dirname + '/colors.css'));
app.get('/' + this_sever + 'a/documentation.css', (req, res) => res.sendFile(__dirname + '/documentation.css'));
app.get('/' + this_sever + 'a/src-min-noconflict/ace.js', (req, res) => res.sendFile(__dirname + '/src-min-noconflict/ace.js'));
app.get('/' + this_sever + 'a/src-min-noconflict/theme-clouds_midnight.js', (req, res) => res.sendFile(__dirname + '/src-min-noconflict/theme-clouds_midnight.js'));
app.get('/' + this_sever + 'a/src-min-noconflict/mode-javascript.js', (req, res) => res.sendFile(__dirname + '/src-min-noconflict/mode-javascript.js'));
app.get('/' + this_sever + 'a/src-min-noconflict/ext-language_tools.js', (req, res) => res.sendFile(__dirname + '/src-min-noconflict/ext-language_tools.js'));
app.get('/' + this_sever + 'a/src-min-noconflict/snippets/javascript.js', (req, res) => res.sendFile(__dirname + '/src-min-noconflict/snippets/javascript.js'));
app.get('/' + this_sever + 'a/src-min-noconflict/worker-javascript.js', (req, res) => res.sendFile(__dirname + '/src-min-noconflict/worker-javascript.js'));
app.get('/' + this_sever + 'a/copenhagen.0-1-4.css', (req, res) => res.sendFile(__dirname + '/copenhagen.0-1-4.css'));
app.get('/' + this_sever + 'a/copenhagen.0-1-4.min.js', (req, res) => res.sendFile(__dirname + '/copenhagen.0-1-4.min.js'));
app.get('/' + this_sever + 'a/anime.min.js', (req, res) => res.sendFile(__dirname + '/anime.min.js'));
app.get('/' + this_sever + 'a/sound.js', (req, res) => res.sendFile(__dirname + '/sound.js'));
app.get('/' + this_sever + 'a/webker.js', (req, res) => res.sendFile(__dirname + '/webker.js'));


app.get('/' + this_sever + 'a/asset/loader.gif', (req, res) => res.sendFile(__dirname + '/assets/loader.gif'));
app.get('/' + this_sever + 'a/asset/dropdown.png', (req, res) => res.sendFile(__dirname + '/assets/dropdown.png'));
app.get('/' + this_sever + 'a/asset/dropdown2.png', (req, res) => res.sendFile(__dirname + '/assets/dropdown2.png'));
app.get('/' + this_sever + 'a/asset/board.png', (req, res) => res.sendFile(__dirname + '/assets/board.png'));
app.get('/' + this_sever + 'a/asset/method-move.gif', (req, res) => res.sendFile(__dirname + '/assets/method-move.gif'));
app.get('/' + this_sever + 'a/asset/method-energize1.gif', (req, res) => res.sendFile(__dirname + '/assets/method-energize1.gif'));
app.get('/' + this_sever + 'a/asset/method-energize2.gif', (req, res) => res.sendFile(__dirname + '/assets/method-energize2.gif'));
app.get('/' + this_sever + 'a/asset/method-merge.gif', (req, res) => res.sendFile(__dirname + '/assets/method-merge.gif'));
app.get('/' + this_sever + 'a/asset/method-divide.gif', (req, res) => res.sendFile(__dirname + '/assets/method-divide.gif'));
app.get('/' + this_sever + 'a/asset/tr-loader.gif', (req, res) => res.sendFile(__dirname + '/assets/tr-loader.gif'));
app.get('/' + this_sever + 'a/asset/ico_long_arr_blue.png', (req, res) => res.sendFile(__dirname + '/assets/ico_long_arr_blue.png'));
app.get('/' + this_sever + 'a/asset/ico_long_arr_purp.png', (req, res) => res.sendFile(__dirname + '/assets/ico_long_arr_purp.png'));
app.get('/' + this_sever + 'a/asset/ico_long_arr_gold.png', (req, res) => res.sendFile(__dirname + '/assets/ico_long_arr_gold.png'));
app.get('/' + this_sever + 'a/asset/gal1.png', (req, res) => res.sendFile(__dirname + '/assets/gal1.png'));
app.get('/' + this_sever + 'a/asset/gal2.png', (req, res) => res.sendFile(__dirname + '/assets/gal2.png'));
app.get('/' + this_sever + 'a/asset/gal3.png', (req, res) => res.sendFile(__dirname + '/assets/gal3.png'));
app.get('/' + this_sever + 'a/asset/gal4.png', (req, res) => res.sendFile(__dirname + '/assets/gal4.png'));

app.get('/' + this_sever + 'a/sound/outfoxing.mp3', (req, res) => res.sendFile(__dirname + '/sound/outfoxing.mp3'));
app.get('/' + this_sever + 'a/sound/enemy_incoming.mp3', (req, res) => res.sendFile(__dirname + '/sound/enemy_incoming.mp3'));

app.get('/' + this_sever + 'a/est', (req, res) => res.sendFile(__dirname + '/est.html'));
app.get('/' + this_sever + 'a/game-status', (req, res) => res.sendFile(__dirname + '/game-status.html'));
app.get('/' + this_sever + 'a/nope', (req, res) => res.sendFile(__dirname + '/nope.html'));
app.get('/' + this_sever + 'a/site.webmanifest', (req, res) => res.sendFile(__dirname + '/site.webmanifest'));
app.get('/' + this_sever + 'a/apple-touch-icon.png', (req, res) => res.sendFile(__dirname + '/apple-touch-icon.png'));
app.get('/' + this_sever + 'a/favicon-32x32.png', (req, res) => res.sendFile(__dirname + '/favicon-32x32.png'));
app.get('/' + this_sever + 'a/favicon-16x16.png', (req, res) => res.sendFile(__dirname + '/favicon-16x16.png'));
